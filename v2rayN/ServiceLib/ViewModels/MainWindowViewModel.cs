...
public partial class MainWindowViewModel : MyReactiveObject
{
    ...
    public MainWindowViewModel()
    {
        ...
        SniSpoofingSettingCmd = ReactiveCommand.CreateFromTask(async () =>
        {
            var viewModel = new SniSpoofingSettingViewModel();
        ...
        StopMhrCmd = ReactiveCommand.CreateFromTask(async () =>
        {
