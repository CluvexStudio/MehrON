...
public partial class OptionSettingWindow
{
    ...
    public OptionSettingWindow()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.ShowAdvancedSettings, v => v.togShowAdvancedSettings.IsChecked).DisposeWith(disposables);
            ...
            this.Bind(ViewModel, vm => vm.TunEngine, v => v.cmbTunEngine.Text).DisposeWith(disposables);
